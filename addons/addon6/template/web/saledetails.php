...
&nbsp;&nbsp;&nbsp;<span>
		 ...
		 <option value="" <?php  echo empty($_GP['dispatch'])?'selected':'';?>>--未选择--</option>
			...
			</span><input type="submit" name="" value=" 查 询" class="btn btn-primary" >&nbsp;&nbsp;&nbsp;<button type="submit" name="saledetailsEXP01" value="saledetailsEXP01" class="btn btn-warning btn-primary">导出excel</button></h4>
