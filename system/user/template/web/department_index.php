...
<div class="department-wrap" style="min-height: 500px;">
	<h3>部门管理<span class="btn btn-info btn-sm add-user">添加人员</span>&nbsp<span class="btn btn-info btn-sm add-department">添加部门</span>&nbsp<span style="margin-top: -3px;margin-left: 10px;" class="btn btn-info btn-sm set-the-department">设置部门</span></h3>
			...
			<div class='modal-dialog'>
				<div class='modal-content'>
					<div class='modal-header'> 
						...
						<h4 class='modal-title' class='myModalLabel'>添加部门</h4>
					</div>
					<div class='modal-body'>
						<div class="add-user-input">
							<table>
								<tr>
									<td class="left-title">部门名称:</td>
			...
			<div class='modal-dialog'>
				<div class='modal-content'>
					<div class='modal-header'> 
						...
						<h4 class='modal-title' class='myModalLabel'>设置经理</h4>
					</div>
					<div class='modal-body'>
...
$(function(){
	...
	$(".add-department").on("click",function(){
		...
		$(".add-user-department .sure-btn").on("click",function(){
			...
			var url = "<?php  echo web_url('department',array('op'=>'add_department'));?>";
			if( department_name == "" ){
				alert("请输入部门名称");
			}else{
	...
	$(".set-the-department").on("click",function(){
		...
		$(".set-department .setup-btn").on("click",function(){
			...
			var url = "<?php  echo web_url('department',array('op'=>'set_department'));?>";
			if( depart_name == "0" ){
				alert("请选择部门");
			}else if(manager == "0"){
				alert("请选择经理");
...
function modify(id){
	var url = "<?php  echo web_url('department',array('op'=>'get_staff'));?>";
	$(".edit_id").val(id);
