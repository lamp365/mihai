...
<body style="padding:10px;">
    <blockquote class="layui-elem-quote"><?php if(empty($_GP['group_id'])){ echo '添加'; }else{ echo '编辑';} ?>角色</blockquote>
    <?php if(empty($_GP['group_id'])){   ?>
    <form action="<?php echo mobile_url('shopruler',array('op'=>'addgroup'));?>" method="post">
    <?php }else{  ?>
    <form action="<?php echo mobile_url('shopruler',array('op'=>'editgroup'));?>" method="post">
    <?php } ?>
