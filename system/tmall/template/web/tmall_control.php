					...
					foreach($al_staff as $almv) { ?>
		                <tr>
		                    ...
		                    <td class="text-center">
		                		...
		                		<a class="btn btn-xs btn-danger"  onclick="return confirm('此操作不可恢复，确认删除？');return false;" href="<?php  echo web_url('tmall_control',array('op'=>'del','id'=>$almv['id']));?>"><i class="icon-edit"></i>删除人员</a>
		                	</td>
		                </tr>
		            <?php  } } ?>
	            </tbody>
