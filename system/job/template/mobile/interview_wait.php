...
<html>
	...
	<body>
		<div class="cart_title" >
		   <span class="return">
		   		<img src="<?php echo RESOURCE_ROOT;?>addons/common/image/job/return.png" width="10px" height="10px">
		   </span>
		</div>
		<!--等待中-->
		<div class="bg">
			<img src="<?php echo RESOURCE_ROOT;?>addons/common/image/job/interview-wait.jpg" />
		</div>
		<!--面试者信息 -->
