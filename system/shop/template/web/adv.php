...
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal" >
  ...
  <div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										     <select name="type">
                                                  <option value='1' <?php  if($adv['type'] == 1) { ?> selected="selected"<?php  } ?>>WEB</option>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										     <select name="page">
												  ...
												  <option value='4' <?php  if($adv['page'] == 5) { ?> selected="selected"<?php  } ?>>首页顶部</option>
												  ...
												  <option value='5' <?php  if($adv['page'] == 4) { ?> selected="selected"<?php  } ?>>限时购</option>
											 </select>
										</div>
									</div>
