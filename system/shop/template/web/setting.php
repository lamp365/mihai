...
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal" >
	   <div class="form-group">
					   ...
					   <div class="form-group">
										<label class="col-sm-2 control-label no-padding-left" > 是否开启伪静态：</label>
										<div class="col-sm-9">
												   <input type="radio" name="shop_rewrite" value="0"  <?php  if($settings['shop_rewrite'] == 0) { ?>checked="true"<?php  } ?> /> 关闭  &nbsp;&nbsp;
              		                               <input type="radio" name="shop_rewrite" value="1"  <?php  if($settings['shop_rewrite'] == 1) { ?>checked="true"<?php  } ?> /> 开启
										</div>
									</div>
							 <div class="form-group">
