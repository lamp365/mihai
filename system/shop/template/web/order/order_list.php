			...
			<tbody>
				...
				<tr class="order_info">
					...
					?>
					    <div class="items">
						      <ul>
							      <li class="img"><a target="_blank" href="<?php  echo mobile_url('detail', array('name'=>'shopwap','id' => $goods['aid']))?>"><img src="<?php echo download_pic($goods['thumb'],40,40,2); ?>" height="40" /></a></li>
