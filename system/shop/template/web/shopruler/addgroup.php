                                    ...
                                    <div class="choose-all-2 clearfix box_p2">
                                        ...
                                        <ul class="right-list clearfix">
                                            <?php foreach($second_menu['child'] as $third_menu){  $p3_check = '';if(in_array($third_menu['main']['id'],$sellergroup['rule'])){ $p3_check="checked";} ?>
                                                <li><label><input type="checkbox" name="rule_id[]" value="<?php echo $third_menu['main']['id']; ?>" class="p3" <?php echo $p3_check;?>><?php echo $third_menu['main']['rule_name']; ?></label></li>
                                            <?php } ?>
                                        </ul>
                                    </div>
                                <?php } ?>
                        ...
                        <div class="layui clearfix">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="checkbox" name="other_rule[]" value="<?php echo $key ?>" title="不允许"  <?php if(in_array($key,$sellergroup['other_rule'])){ echo "checked";} ?>>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
...
$(function(){
    ...
    $(".left-list").on("click",function(){
        ...
        if( flag == true ){
            ...
            //如果p2全部打钩的  父类 p1就打钩
            var p2_num = $(this).parents(".choose-box").find(".p2").length;
            var p2_i   = 0;
    ...
    $(".p3").on("click",function(){
        if(this.checked){
            //如果p3全部打钩的  父类 p2就打钩
            var p3_num = $(this).parents(".right-list").find(".p3").length;
            var p3_i   = 0;
