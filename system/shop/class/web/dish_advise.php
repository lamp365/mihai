		...
		<?php $index=0; if(is_array($list)) { $index=$index+1; foreach($list as $item) { ?>
				<tr>
                 ...
                 <td style="text-align:center;"><?php  echo $item['descript'];?></td>
                  <td style="text-align:center;"><a href='' target="_blank"><img src='<!--@php echo WEBSITE_ROOT;@-->/attachment/<!--@php  echo $item['thumb'];@-->' width="100px;" ></a></td>
				 <td style="text-align:center;"><?php  echo date("Y-m-d",$item['createtime']);?></td>
										<td style="text-align:center;">
						<a  class="btn btn-xs btn-info" href="<?php  echo mobile_url('dish', array('id' => $item['id'], 'op' => 'delete','name'=>'shopwap'))?>" 
