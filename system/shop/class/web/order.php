...
class order extends \common\controller\basecontroller
{
	...
	public function detail()
	{
		...
		$goods = mysqld_selectall("SELECT d.*,o.total,o.id as order_id,o.total,o.price as orderprice,o.status as order_status, o.type as order_type FROM " . table('shop_order_goods') . " o left join " . table('shop_dish') . " d on o.goodsid=d.id "
