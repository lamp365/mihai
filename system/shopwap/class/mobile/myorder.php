...
}elseif($op == 'identity_submit')
{
    ...
    if (!empty($listorder)) {
        foreach ($listorder as &$orderow) {
            $goods = mysqld_selectall("SELECT g.id, g.title, g.thumb,g.pcate, o.price as marketprice,o.total,o.aid,o.status as order_status, o.type as order_type,o.shop_type FROM " . table('shop_order_goods') . " o left join " . table('shop_goods') . " g on o.shopgoodsid=g.id "
